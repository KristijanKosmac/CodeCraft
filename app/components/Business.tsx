  ...
  <section id="expertise" className="section">
    ...
    >
      <h2 className="heading2">
        You dream it,<br className="sm:block hidden" /> we build it.
      </h2>
      <p className="paragraph max-w-[470px] mt-5">
      From concept to reality, our team brings your vision to life. 
      Let us handle the development while you focus on making your dreams a reality.
      </p>
