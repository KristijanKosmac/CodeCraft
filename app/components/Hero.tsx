...
import Futuristic from "../../public/futuristic.svg"
  ...
  return (
    <section id="home" className="flex md:flex-row flex-col paddingY">
      ...
      >
        ...
        Crafting code with the latest technologies and a touch of creativity, 
        our expert team delivers applications that redefine excellence.
        We merge innovation with skill,
        transforming your ideas into finely crafted digital experiences.
        </p>
      </motion.div>

      <motion.div
        className="flexCenter md:my-0 my-10 relative"
